<template>
  <div v-loading="audio.waiting" class="di main-wrap">
    ...
    <div>
      ...
      <el-slider v-show="!controlList.noVolume" v-model="volume" :format-tooltip="formatVolumeToolTip" class="slider" @change="changeVolume"/>

      <a v-show="!controlList.noDownload" :href="url" target="_blank" class="download" download>下载</a>
    </div>
  </div>
</template>
