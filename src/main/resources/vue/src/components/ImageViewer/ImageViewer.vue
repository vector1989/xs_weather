<template>
  <div v-if="visible" @click="hideImage">
    <div :style="{ backgroundColor:background }" class="see-image">
      <img
        v-drag="greet"
        id="drag"
        ref="user_image"
    ...
    <div v-show="closeButtonVisible" class="close" @click="close"><img src="./icon/close.png"></div>
    <div v-show="rotateButtonVisible" class="rotate" @click.stop="rotateImage"><img src="./icon/rotate.png"></div>
